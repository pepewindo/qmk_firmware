...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+----------|
                                                 LT(5,KC_ESC),MT(MOD_LSFT,KC_BSPC), LT(4,KC_SPC),   LT(6,KC_ENT), KC_RALT, OSM(MOD_LSFT)
                                                    //`-----------------------------------------'  `----------------------------------'
        ),

    [_ENGLISH] = LAYOUT_split_3x6_3(
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+----------|
             KC_ESC,    KC_Q,        KC_W,        KC_E,        KC_R,          KC_O,                                  KC_Y,        KC_U,        KC_I,     KC_SCLN,      KC_P,    KC_TAB,
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+----------|
              TO(0),    KC_A, GUI_T(KC_S), CTL_T(KC_D), ALT_T(KC_F),          KC_G,                                  KC_H, ALT_T(KC_J), CTL_T(KC_K), GUI_T(KC_L),      KC_T,    KC_DEL,
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+----------|
            KC_LGUI,    KC_Z,        KC_X,         KC_C,       KC_V,          KC_B,                                  KC_N,        KC_M,     KC_COMM,      KC_DOT,   KC_SLSH,    KC_END,
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+----------|
                                                              MO(2), LT(4,KC_BSPC), LT(6,KC_SPC),   LT(6,KC_ENT), KC_RALT, OSM(MOD_LSFT)
                                                    //`-----------------------------------------'  `----------------------------------'
        ),
    ...
    [_NAV_NUM] = LAYOUT_split_3x6_3(
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
             KC_ESC, KC_CAPS, KC_HOME,   KC_UP,  KC_END, KC_PGUP,                      KC_PMNS,  KC_7,  KC_8,  KC_9, KC_PSLS, KC_TRNS,
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
            KC_TRNS,  KC_TAB, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                      KC_PPLS,  KC_4,  KC_5,  KC_6,    KC_0,  KC_DEL,
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
            KC_TRNS,  KC_ESC, KC_PSCR,  KC_INS, KC_WBAK, KC_WFWD,                         KC_N,  KC_1,  KC_2,  KC_3,  KC_DOT, KC_CALC,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+------+------+------+--------+--------|
    ...
    [_MIR_FUNC] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+-------+--------+--------+--------------+--------|  |--------+-------+--------+------+------+-------+--------|
                                         OSM(MOD_LSFT), OSM(MOD_RALT), KC_TRNS,     KC_ENT, KC_DEL, KC_TRNS
                                        //`-----------------------------------'  `-------------------------'
        ),
