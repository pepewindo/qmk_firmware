...
enum combos {CO_ESC, XMIN_ESC, DDK_ENT, GCOM_ENT};

const uint16_t PROGMEM esc_combo1[] = {EL_C, EL_O   , COMBO_END};
const uint16_t PROGMEM esc_combo2[] = {EL_X, EL_MINS, COMBO_END};
const uint16_t PROGMEM ent_combo3[] = {EL_D, EL_1DK , COMBO_END};
const uint16_t PROGMEM ent_combo4[] = {EL_G, EL_COMM, COMBO_END};

combo_t key_combos[] = {
    [CO_ESC]   = COMBO(esc_combo1, KC_ESC),
    [XMIN_ESC] = COMBO(esc_combo2, KC_ESC),
    [DDK_ENT]  = COMBO(ent_combo3, KC_ENT),
    [GCOM_ENT] = COMBO(ent_combo4, KC_ENT),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+--------------|
                                                 LT(5,KC_ESC),MT(MOD_LSFT,KC_BSPC), LT(4,KC_SPC),   OSM(MOD_RALT), OSM(MOD_LSFT), LT(6,KC_ESC)
                                                    //`-----------------------------------------'  `----------------------------------'
        ),
    ...
    [_SELENIUM] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+--------------|
            KC_LGUI,    KC_Z,        KC_X,         KC_C,       KC_V,          KC_B,                                  KC_N,        KC_M,     KC_COMM,      KC_DOT,   KC_SLSH,        KC_DEL,
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+--------------|
                                                      LT(5,KC_ESC), OSM(MOD_LSFT), LT(4,KC_BSPC),   LT(4,KC_SPC), OSM(MOD_RALT), LT(6,KC_ESC)
                                                    //`-----------------------------------------'  `----------------------------------'
        ),
    ...
    [_NAV_NUM] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+------+------+------+--------+--------|
                                                KC_TRNS, KC_TRNS, KC_TRNS,     KC_ENT,  KC_DEL, KC_PSLS
                                            //`--------------------------'  `--------------------------'
        ),
    ...
    [_MIR_FUNC] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+-------+--------+--------+--------------+--------|  |--------+-------+--------+------+------+-------+--------|
                                         KC_TRNS, OSM(MOD_LSFT), OSM(MOD_RALT),    KC_ENT, KC_DEL, KC_TRNS
                                        //`-----------------------------------'  `-------------------------'
        ),
