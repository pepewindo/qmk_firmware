...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+----------|
                                                              MO(2), LT(4,KC_BSPC), LT(5,KC_SPC),   LT(6,KC_ENT), KC_RALT, OSM(MOD_LSFT)
                                                    //`-----------------------------------------'  `----------------------------------'
        ),
    ...
    [_NAV_NUM] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
            KC_TRNS,  KC_ESC, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                      KC_PPLS,  KC_4,  KC_5,  KC_6,    KC_0,  KC_DEL,
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
            KC_TRNS, KC_CAPS, KC_PSCR,  KC_INS, KC_WBAK, KC_WFWD,                         KC_N,  KC_1,  KC_2,  KC_3,  KC_DOT, KC_CALC,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+------+------+------+--------+--------|
                                                KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS,  KC_SPC,  KC_0
                                            //`--------------------------'  `------------------------'
        ),
    ...
    [_MOUSE_NAV] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------|                  |--------+--------+--------+--------+--------+--------|
            KC_TRNS, KC_TRNS, MS_WHLL, MS_WHLD, MS_WHLR, KC_TRNS,                    KC_VOLD, MS_LEFT, MS_DOWN, MS_RGHT, KC_TRNS, KC_TRNS,
        //|--------+--------+--------+--------+--------+--------|                  |--------+--------+--------+--------+--------+--------|
            KC_TRNS, KC_TRNS, MS_ACL0, MS_ACL1, MS_ACL2, KC_TRNS,                    KC_MUTE, MS_BTN1, MS_BTN3, MS_BTN2, KC_TRNS, KC_TRNS,
        //|--------+--------+--------+--------+--------+--------+-------|  |-------+--------+--------+--------+--------+--------+--------|
