...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3( // 0
        ...
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+--------------|
              TO(2),    KC_A, GUI_T(KC_S), CTL_T(KC_D), ALT_T(KC_F),          KC_G,                                  KC_H, ALT_T(KC_J), CTL_T(KC_K), GUI_T(KC_L), SFT_T(KC_SCLN),   KC_END,
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+--------------|
    ...
    [_ALTGR] = LAYOUT_split_3x6_3( // 1
        //|--------+-----------+-----------+-----------+-----------+-----------|                         |----------+-----------+--------------+-------------+--------------+--------------|
             KC_TAB, RALT(KC_Q), RALT(KC_W), RALT(KC_E), RALT(KC_R), RALT(KC_T),                          RALT(KC_Y), RALT(KC_U),    RALT(KC_I),   RALT(KC_O),    RALT(KC_P), RCTL(KC_BSPC),
        //|--------+-----------+-----------+-----------+-----------+-----------|                         |----------+-----------+--------------+-------------+--------------+--------------|
              TO(2), RALT(KC_A), RALT(KC_S), RALT(KC_D), RALT(KC_F), RALT(KC_G),                          RALT(KC_H), RALT(KC_J),    RALT(KC_K),   RALT(KC_L), RALT(KC_SCLN),        KC_END,
        //|--------+-----------+-----------+-----------+-----------+-----------|                         |----------+-----------+--------------+-------------+--------------+--------------|
            KC_LGUI, RALT(KC_Z), RALT(KC_X), RALT(KC_C), RALT(KC_V), RALT(KC_B),                          RALT(KC_N), RALT(KC_M), RALT(KC_COMM), RALT(KC_DOT), RALT(KC_SLSH),        KC_DEL,
        //|--------+ ----------+-----------+-----------+-----------+-----------+----------|   |----------+----------+-----------+--------------+-------------+--------------+--------------|
    ...
    [_SYMB_NUM] = LAYOUT_split_3x6_3( // 2
        ...
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_TRNS,CTL_T(KC_X),CTL_T(KC_W),CTL_T(KC_V), KC_M, KC_PSLS,                   KC_N, KC_PPLS, KC_PMNS,  KC_DOT, KC_PSLS,  KC_DEL,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
