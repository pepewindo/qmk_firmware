...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_LALT, LT(3,KC_BSPC), KC_SPC,     KC_ENT, OSM(MOD_LSFT), KC_RALT
                                            //`--------------------------'  `--------------------------'
        ),
    ...
    [_NAV_NUM] = LAYOUT_split_3x6_3(
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
             KC_TAB, KC_LALT, KC_HOME,   KC_UP,  KC_END, KC_PGUP,                      KC_PMNS,    KC_7,    KC_8,    KC_9, KC_PSLS,  KC_ESC, 
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_CAPS, KC_LCTL, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,                      KC_PPLS,    KC_4,    KC_5,    KC_6, KC_PAST,  KC_DEL, 
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_PSCR, KC_MUTE, KC_VOLD, KC_VOLU, KC_WBAK, KC_WFWD,                         KC_N,    KC_1,    KC_2,    KC_3,  KC_EQL, KC_CALC, 
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                                 KC_INS, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_0,  KC_DOT
                                            //`--------------------------'  `--------------------------'
        )
};
