...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ENGLISH] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+----------|
              TO(0),    KC_A, GUI_T(KC_S), CTL_T(KC_D), ALT_T(KC_F),          KC_G,                                  KC_H, ALT_T(KC_J), CTL_T(KC_K), GUI_T(KC_L),      KC_T,    KC_END,
        //|--------+--------+------------+------------+------------+--------------|                       |--------------+------------+------------+------------+----------+----------|
            KC_LGUI,    KC_Z,        KC_X,         KC_C,       KC_V,          KC_B,                                  KC_N,        KC_M,     KC_COMM,      KC_DOT,   KC_SLSH,    KC_DEL,
        //|--------+--------+------------+------------+------------+--------------+-------------|  |------+--------------+------------+------------+------------+----------+----------|
    ...
    [_NAV_NUM] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+--------+--------+--------+--------|                    |--------+------+------+------+--------+--------|
            KC_TRNS, KC_WBAK, KC_PSCR,  KC_INS,  KC_ESC, KC_WFWD,                         KC_N,  KC_1,  KC_2,  KC_3,  KC_DOT, KC_DEL,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+------+------+------+--------+--------|
    ...
    [_MIR_FUNC] = LAYOUT_split_3x6_3(
        ...
        //|--------+--------+-------+--------+--------+--------------+--------|  |--------+-------+--------+------+------+-------+--------|
                                         OSM(MOD_LSFT), KC_TRNS, OSM(MOD_RALT),     KC_ENT, KC_DEL, KC_TRNS
                                        //`-----------------------------------'  `-------------------------'
        ),
